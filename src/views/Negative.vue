...
export default {
  ...
  methods: {
    async export_request() {
      ...
      await http
        .get(
          `megafon/${action}/count?start_date=${start}&end_date=${end}&export_format=csv&sentiment=negative`,
          {
            responseType: 'blob'
          }
        )
    ...
    async export_request_coeff() {
      ...
      await http
        .get(
          `megafon/${action}/count?start_date=${start}&end_date=${end}&brand=мегафон&export_format=csv&sentiment=negative`,
          {
            responseType: 'blob'
          }
        )
    ...
    async export_request_date() {
      ...
      await http
        .get(
          `megafon/${action}/date?start_date=${start}&end_date=${end}&export_format=csv&sentiment=negative`,
          {
            responseType: 'blob'
          }
        )
    ...
    async export_request_prod() {
      ...
      await http
        .get(
          `megafon/${action}/products/count?start_date=${start}&end_date=${end}&export_format=csv&sentiment=negative`,
          {
            responseType: 'blob'
          }
        )
    ...
    async request_video_ordered_exp() {
      ...
      await http
        .get(
          `megafon/video?brand=мегафон&order_by=${action}&start_date=${start}&end_date=${end}&export_format=csv&sentiment=negative`
        )
        .then(response => {
          fileDownload('\uFEFF' + response.data, 'report.csv', 'text/csv')
        })
    ...
    async request_post_ordered_exp() {
      ...
      await http
        .get(
          `megafon/post?brand=мегафон&order_by=${action}&start_date=${start}&end_date=${end}&export_format=csv&sentiment=negative`
        )
        .then(response => {
          fileDownload('\uFEFF' + response.data, 'report.csv', 'text/csv')
        })
